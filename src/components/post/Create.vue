                ...
                <div class="fc-mid">
                    <div class="fc-col-1">
                        <div class="fc-add-pict">
                            ...
                            <div 
                                v-if="txtMessage" 
                                class="txt-site txt-11 txt-red txt-thin padding-top-5px">
                                {{ messageFile }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div v-if="basicInfo">
                            <form @submit.prevent="doPublishDesign">
                                <div class="fc-block no-margin-top">
                                    ...
                                    <div v-if="framePaperMessage" class="txt-site txt-11 txt-red txt-thin padding-top-5px">
                                        {{ paperMessage }}
                                    </div>
                                </div>
                                <div class="fc-block">
    ...
    methods: {
        ...
        doPublishDesign: function () {
            ...
            else if (this.dt.idcanvas == '' || this.dt.idcanvas == null) 
            {
                ...
                this.paperMessage = 'Please choose a paper';
