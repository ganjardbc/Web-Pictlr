<template>
    <div>
                ...
                <div class="frame-post fp-tumbler" :key="dg.idbookmark">
                    ...
                    <div class="fpt-col-2">
                        <div class="mid">
                            ...
                            <div class="top-tool tt-grid-2x margin-bottom-10px">
                                <div class="tt-col-1">
                                    <div class="txt-site txt-10">
                                        <span class="txt-site txt-thin txt-primary">Posted on</span>
                                        <router-link 
                                            class="txt-site txt-primary txt-bold txt-main-hover"
                                            :to="{
                                                name: 'visit-canvas', 
                                                params: {
                        ...
                        <div class="mid">
                            <div 
                                ...
                                class="txt-site txt-16 txt-extra-bold txt-main margin-10px">
                                    {{ dg.title_design }}
                            </div>
                            <div
                                v-if="dg.description_design" 
                                class="txt-site txt-11 txt-main txt-font-2 margin-10px">
                            ...
                            <div class="oth-tool">
                                <div class="ot-col-1">
                                    ...
                                    <router-link :to="{name: 'edit-post', params: {idbookmark: dg.idbookmark}}">
                                        <button 
                                            class="btn-icn btn btn-radius btn-main2-color"
                                            v-if="$cookie.get('id') == dg.id">
                                            <span class="icn fa fa-lg fa-pencil-alt"></span>
                                        </button>
                                    </router-link>
                                    <button 
                                            class="btn-icn btn btn-circle btn-main2-color"
        ...
        <div v-if="loadMore" class="frame-more padding-15px">
            <button class="btn btn-sekunder-color btn-radius" @click="moreDesign">
                <span>Load More</span>
            </button>
        </div>
