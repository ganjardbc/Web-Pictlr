            ...
            <masonry 
                ...
                <div v-for="(dg, idx) in designs" v-bind:key="idx">
                    <div class="frame-post" :key="dg.idbookmark">
                        <div class="mid">
                            <div class="mid-tool">
                                <div class="bot-tool abs">
                                    <div class="nts">
                                        <button class="btn btn-circle btn-grey3-color">
                                            <span class="fas fa-lg fa-share-alt"></span>
                                        </button>
                                        <router-link :to="{name: 'edit-post', params: {idbookmark: dg.idbookmark}}">
                                            <button 
                                                class="btn btn-circle btn-grey3-color"
                                    ...
                                    <div class="bok">
                                        <button 
                                            class="btn btn-radius btn-main-color"
                                            @click="doSave(
                                                dg.idbookmark,
                                                dg.idimages,
                        ...
                        <div class="mid">
                            ...
                            <!-- <div class="top-tool">
                                ...
                                <div class="tt-col-2">
                                    <div class="tt-info">
                                        <div class="txt-site txt-10 txt-bold txt-primary">
                                            <router-link :to="{path: '/'+dg.username+'/canvas/'+dg.idcanvas}">
                                                {{ dg.title }}
                                            </router-link>
                                        </div>
