            ...
            <div v-for="dt in notifs">
                ...
                <div v-if="dt.type == 'watch'">
                    <div class="frame-notif grid-3x">
						<div class="notif-sid">
                            <router-link :to="{name: 'user-posts', params: {username: dt.username}}">
								<div 
						...
						<div class="notif-mid">
							<div class="ntf-mid">
								<div class="desc">
                                    <span class="txt-site txt-11 txt-main txt-thin">Your canvas</span>
                                    <router-link 
                                    ...
                                    <span class="txt-site txt-11 txt-main txt-thin">was watched by</span>
									<router-link 
                                        class="txt-site txt-11 txt-main txt-bold txt-main-hover"
                                        :to="{name: 'user-posts', params: {username: dt.username}}">
                                        {{ dt.name }}
									</router-link>
								</div>
								<div class="date">
                ...
                <div v-if="dt.type == 'bookmark'">
                    <div class="frame-notif grid-3x">
						<div class="notif-sid">
                            <router-link :to="{name: 'index-post', params: {idbookmark: dt.idbookmark}}">
                                <div 
						...
						<div class="notif-mid">
							<div class="ntf-mid">
								<div class="desc">
                                    <span class="txt-site txt-11 txt-main txt-thin">Your post was saved by</span>
									<router-link 
                                        class="txt-site txt-11 txt-main txt-bold txt-main-hover"
                                        :to="{name: 'user-posts', params: {username: dt.username}}">
                                        {{ dt.name }}
                        ...
                        <div class="notif-rig">
                            <router-link :to="{name: 'index-post', params: {idbookmark: dt.idbookmark}}">
                                <button class="btn btn-grey4-color btn-circle">
						...
						<div class="notif-mid">
							<div class="ntf-mid">
								<div class="desc">
									...
									<span>
                                        <span class="txt-site txt-11 txt-primary txt-thin">
                                            Liked your post
                                        </span>
                                    </span>
								</div>
						...
						<div class="notif-mid">
							<div class="ntf-mid">
								<div class="desc">
                                    ...
                                    <span class="txt-site txt-11 txt-main txt-thin">
                                        send a response on your post
                                    </span>
								</div>
                                <div class="padding-5px">
                                    <span class="txt-site txt-12 txt-main txt-bold">"{{ dt.description }}"</span>
                                </div>
								<div class="date">
									{{ dt.created | moment("from", "now") }}
								</div>
