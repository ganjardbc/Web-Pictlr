...
Vue.prototype.baseUrl = 'https://pictlr.undangabi.com'
...
Vue.prototype.$opAddDesign = function (stt) {
  if (stt == 'open') {
      $('#add-design').show()
  } else {
      $('#add-design').hide()
...
Vue.prototype.$opAddPaper = function (stt) {
  if (stt == 'open') {
      $('#add-paper').show()
  } else {
      $('#add-paper').hide()
...
//edit design
Vue.prototype.$editDesign = function (id, idimage) {
  if (id == null) {
      this.$openMessageOk('Please login before you can edit this design')
  } else {
      $('#edit-design').show()
  }
}
...
//likes
Vue.prototype.$likeDesign = function (id, idimage) {
  if (id == null) 
  {
  ...
  {
      var vm = this
      var tr = $('.like-'+idimage).find('.icn').attr('id')
      if (tr == 'unlike') 
      {
          $('.like-'+idimage)
          .find('.icn')
      ...
      axios.post(
          vm.baseUrl+'/api/likes/save?token='+vm.$cookie.get('jwt'),
          {
              'idimage': idimage,
          }
      )
